...
namespace LinqApp
{
    internal class Program
    {
        ...
        public static List<int> MapToOddDoubleToList(int[] arr)
        {
            //return (from num in arr
            //        where num % 2 != 0
            //        select num * 2).ToList();
        ...
        {
            return (from num in arr select num).Skip(page - 1).Take(pageSize).ToArray();
        ...
        public static double AvgAll(int[] arr)
        {
            return arr.Average();
        }
        ...
        public static bool AllGreaterThanNum(int[] arr, int num)
        {
            return arr.All(n => n > num);

        }

        public static bool AnyGreaterThanNum(int[] arr, int num)
        {
